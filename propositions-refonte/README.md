...
## Round 7 — polish hero (30/08/2026)

Vidéo grid de search-party (ré-encodée H.264, 805 Ko) embarquée en fond du texte du hero, chargée seulement ≥1024px et hors reduced-motion via un garde matchMedia (zéro octet vidéo en mobile). Diagramme redessiné en ENTONNOIR au standard search-party : 5 chips rondes à libellés deux lignes en haut, col « YOUR BUSINESS » à crochets pointillés, gros nœud $ vert à glow pulsé en destination bas ; accents (hexagone jaune, losanges sur lignes, wash triangulaire). Easing cubique partout (SMIL keySplines 0.4 0 0.2 1, pops d'entrée au scroll). FAQ : padding-top 120px. Audit responsive 5 largeurs, zéro overflow. ~1,27 Mo (dont 1,07 Mo de vidéo).
